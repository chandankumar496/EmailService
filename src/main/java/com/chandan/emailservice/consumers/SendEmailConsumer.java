package com.chandan.emailservice.consumers;

import com.chandan.emailservice.dtos.SendEmailMessageDto;
import com.chandan.emailservice.utils.EmailUtil;
         ...
         try{
             ...
             Authenticator auth = new Authenticator() {
                 ...
                 protected PasswordAuthentication getPasswordAuthentication() {
                     return new PasswordAuthentication("sampletest040496@gmail.com", "");
                 }
             };
